 ...
 * using try_lock() to perform a mutex lock()
 * it allows to a program to parallelize processes
 * a thread can continue working until a mutex is available to be locked
 */
#include <thread>
#include <mutex>
#include <chrono>
